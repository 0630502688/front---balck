      ...
      <div className="p-8 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 flex flex-col gap-2">
            <button type="submit" onChange={handleSubmit} className="px-4 py-2 text-white bg-indigo-500 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600">ลงทะเบียน</button>
